...
// Registry compartilhado: use `stroke="currentColor"`, viewBox 0 0 24 24.
// API: <Icon name="..." size={n} />. Stroke herda a cor do container.
const ICON_PATHS: Record<string, ReactNode> = {
  // ── do marketing-hub (mantidos idênticos) ──
